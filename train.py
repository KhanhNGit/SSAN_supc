...
def main(args):
    ...
    for epoch in range(start_epoch, args.num_epochs):
        ...
        for i, sample_batched in enumerate(train_loader):
            ...
            cls_x1, fea_x1, cls_x1_x1, fea_x1_x1, fea_x1_x2 = model(image_x, image_x[rand_idx, :, :, :])

            binary_loss_x1 = binary_fuc(cls_x1, label[:, 0].long())
            binary_loss_x1_x1 = binary_fuc(cls_x1_x1, label[:, 0].long())
            binary_loss = (binary_loss_x1 + binary_loss_x1_x1)/2
...
def validate(model, test_loader, score_root_path, epoch, name=""):
    ...
    with torch.no_grad():
        ...
        for i, sample_batched in enumerate(test_loader):
            ...
            cls_x1, fea_x1, cls_x1_x1, fea_x1_x1, fea_x1_x2 = model(image_x, image_x)
